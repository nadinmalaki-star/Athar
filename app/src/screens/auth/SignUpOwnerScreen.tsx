...
export function SignUpOwnerScreen() {
  ...
  const canSubmit = salonName && fullName && email && password.length >= 6;
  ...
  return (
    <KeyboardAvoidingView style={styles.flex} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
        <Text style={styles.hint}>رح ننشئلك صالون جديد على التطبيق — تقدري تضيفي خدمات وعميلات بعدين.</Text>
        <TextField label="اسم الصالون" value={salonName} onChangeText={setSalonName} />
